...
class VoiceConnection extends EventEmitter {
   ...
   *  .catch(console.error);
   */
  playStream(stream, obj) { var seek = obj.seek || 0, volume = obj.volume || 1, passes = obj.passes || 1;
   ...
   * @returns {StreamDispatcher}
   */
  playConvertedStream(stream, obj) { var seek = obj.seek || 0, volume = obj.volume || 1, passes = obj.passes || 1;
    const options = { seek, volume, passes };
