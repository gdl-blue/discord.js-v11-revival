...
class VoiceConnectionPlayer extends EventEmitter {
  ...
  convertStream(stream, obj) { var seek = obj.seek || 0, volume = obj.volume || 1, passes = obj.passes || 1;
  ...
  playPCMStream(pcmStream, obj) { var seek = obj.seek || 0, volume = obj.volume || 1, passes = obj.passes || 1;
    const options = { seek, volume, passes };
